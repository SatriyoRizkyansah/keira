class Instructions {
  ...
  toggleVisibility() {
    ...
    this.instructionTexts_.forEach((t) => {
      t.visible = !t.visible;
    });
  }
  ...
  addAllInstructions_() {
    ...
    f("Keira", left + 61 - 3, top - 3, pattyColor).setStroke(pattyStrokeColor, 6);
    ...
    f("Keira", left + 83 - 3, top - 3, pattyColor).setStroke(pattyStrokeColor, 6);
